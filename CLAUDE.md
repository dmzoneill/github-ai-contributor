...
4. **Max 1 open PR per upstream repo**
5. Max 12 fix attempts per iteration
...
- **Max 1 open feature suggestion per upstream repo** — do not create more if at limit
...
- **Max 12 fix attempts per iteration**
